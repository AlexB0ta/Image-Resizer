...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_image_resize_graysca_0_2_sim_netlist.vhdl
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_image_resize_grayscale is
  ...
  signal x_counter : STD_LOGIC_VECTOR ( 10 downto 2 );
  signal \x_counter[10]_i_1_n_0\ : STD_LOGIC;
  signal \x_counter[10]_i_2_n_0\ : STD_LOGIC;
  signal \x_counter[10]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of m_axis_tlast_i_1 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of m_axis_tlast_i_3 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of m_axis_tvalid_i_1 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \output_block[0][5]_i_12\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \output_block[0][5]_i_9\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \x_counter[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \x_counter[5]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \y_counter[10]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \y_counter[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \y_counter[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \y_counter[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \y_counter[5]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \y_counter[6]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \y_counter[7]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \y_counter[8]_i_1\ : label is "soft_lutpair2";
begin
...
\x_counter[10]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\x_counter[10]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\x_counter[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\x_counter[4]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2A80"
    )
        port map (
...
\x_counter[6]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF0000"
    )
        port map (
...
\x_counter[9]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\y_counter[10]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\y_counter[10]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"DF002000"
    )
        port map (
...
\y_counter[10]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_1_image_resize_graysca_0_2,image_resize_grayscale,{}";
